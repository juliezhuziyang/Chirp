    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-orange-700 font-semibold text-sm">{t('home.badge')}</span>
            </motion.div>
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-20" style={{ zIndex: 2 }}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <FeatureCard
            icon={Waves}
            title={t('home.featurePatternTitle')}
            description={t('home.featurePatternDesc')}
            delay={0}
          />
          <FeatureCard
            icon={Target}
            title={t('home.featureBehaviorTitle')}
            description={t('home.featureBehaviorDesc')}
            delay={0.1}
          />
          <FeatureCard
            icon={Brain}
